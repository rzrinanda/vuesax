...
export default{
    ...
    computed: {
        ...
        unreadMails() {
            return (mailType) => this.$store.getters['mail/unreadMails'](mailType);
        },
        draftMails() {
            return this.$store.getters['mail/NumdraftMails'];
        },
    },
    methods: {
        updateFilter(filterName) {
            this.$store.dispatch('mail/updateMailFilter', filterName);
