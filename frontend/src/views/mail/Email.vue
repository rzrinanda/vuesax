...
export default{
    ...
    computed: {
        mailFilter() {
            return this.$store.state.mail.mail_filter;
        },
        emailTags() {
            return this.$store.state.mail.mailTags;
        },
        searchQuery: {
            get() {
                return this.$store.state.mail.mailSearchQuery;
            },
            set(val) {
                this.$store.dispatch('mail/setMailSearchQuery', val);
            }
        },
        selectAllCheckBox: {
            get() {
        ...
        mails() {
            return this.$store.getters['mail/filteredMails'];
        },
        isMailOpen() {
    ...
    methods: {
        updateOpenMail(mailId) {
            ...
            this.$store.dispatch('mail/updateMailUnread', payload);
        ...
        moveTo(to) {
            ...
            this.$store.dispatch('mail/moveMailsTo', payload)
            this.selectedMails = [];
        },
        moveCurrentTo(to) {
        ...
        toggleIsStarred() {
            ...
            this.$store.dispatch('mail/toggleIsMailStarred', payload)
        },
        nextMail() {
        ...
        addLabelToMails(label) {
            ...
            this.$store.dispatch('mail/addLabelToMails', payload);
            this.selectedMails = [];
        },
